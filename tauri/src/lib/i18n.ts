...
const translations: Record<string, Record<string, string>> = {
    "zh-CN": {
        ...
        "settings.logs.time": "时间",
        "settings.logs.user": "用户",
        "settings.logs.action": "操作类型",
        "settings.logs.detail": "详细描述",
        "settings.logs.filter.all": "全部",
        "settings.logs.filter.action": "筛选操作类型",
        "settings.logs.filter.user": "筛选用户",
        "settings.logs.action.add_account": "添加账号",
        "settings.logs.action.edit_account": "编辑账号",
        "settings.logs.action.delete_account": "删除账号",
        "settings.logs.action.migrate_local": "本地迁移",
        "settings.logs.action.migrate_cloud": "云端迁移",
        "settings.logs.action.delete_flow": "删除流程",
        "settings.logs.total": "共 {total} 条记录",
    ...
    "en-US": {
        ...
        "settings.logs.time": "Time",
        "settings.logs.user": "User",
        "settings.logs.action": "Action",
        "settings.logs.detail": "Detail",
        "settings.logs.filter.all": "All",
        "settings.logs.filter.action": "Filter by action",
        "settings.logs.filter.user": "Filter by user",
        "settings.logs.action.add_account": "Add Account",
        "settings.logs.action.edit_account": "Edit Account",
        "settings.logs.action.delete_account": "Delete Account",
        "settings.logs.action.migrate_local": "Local Migration",
        "settings.logs.action.migrate_cloud": "Cloud Migration",
        "settings.logs.action.delete_flow": "Delete Flow",
        "settings.logs.total": "Total {total} records",
